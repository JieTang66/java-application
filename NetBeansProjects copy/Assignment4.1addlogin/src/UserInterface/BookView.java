...
public class BookView extends javax.swing.JPanel {
   ...
   BookView(JPanel rightPanel, Flight a,CustomerDirectory cusDir,FlightSchedule flightS) {
     ...
     private void populateCarDetails(){
       ...
       for(int i=0;i<a.getSeatNumber();i++){
            comboUser.addItem(String.valueOf(a.gennerateSeat().get(i)));
        }
    }
    /**
    ...
    private void btnBookActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBookActionPerformed
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Please type in a number for idnumber");
            return;
        }
        ...
        a.list3.remove(comboUser.getItemAt(comboUser.getSelectedIndex()));
        ...
        customer.setSeat(comboUser.getItemAt(comboUser.getSelectedIndex()));
