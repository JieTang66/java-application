...
public class FlightSchedule{
    ...
    public FlightSchedule() throws ParseException {
        flightList=new ArrayList<>();
        Flight flight1 = new Flight("flight1","8:00","10:30","morning","Boston","Lexington","2019-12-03",air.airlinerList.get(0));
        Flight flight2 = new Flight("flight2","18:00","21:00","evening","New York","Lexington","2019-10-02",air.airlinerList.get(1));
        Flight flight3 = new Flight("flight3","12:38","14:54","daytime","Boston","WashingtonDC","2019-09-06",air.airlinerList.get(2));
        Flight flight4 = new Flight("flight4","12:08","15:58","daytime","LA","Boston","2019-12-31",air.airlinerList.get(3));
        Flight flight5 = new Flight("flight5","19:43","22:00","evening","Seattle","Boston","2019-12-30",air.airlinerList.get(4));
    ...
    public int getSeatNumber(Airliner airliner){
       return airliner.getSeatNumber();
    }
    ...
    public ArrayList<Flight> searchDate(String date){
        ...
        for(Flight f : flightList){
            if(new SimpleDateFormat("yyyy-MM-dd").format(f.getDate()).equals(date)){
                result5.add(f);
            }
        }
        return result5;
