...
public class Lab7 {
    ...
    private Comment generateComment(String[] row){
        ...
        DataStore.getInstance().getComments().put(commentId, comment);
    ...
    private void generatePost(String[] row, Comment comment){
        ...
        if(posts.containsKey(postId)){
            ...
            Post post = new Post(postId,postingUserId);
    ...
    private void runAnalysis(){
        ...
        helper.mostLikedPost();
        helper.mostCommentsPost();
        helper.aveNumOfLikePerComment();
        helper.topFiveInactiveUsersOfPosts();
    }
}
