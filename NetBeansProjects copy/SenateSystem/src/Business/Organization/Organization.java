...
public abstract class Organization {
    ...
    public enum Type{
        Dietitian("Dietitian Organization"), Client("Client Organization"),Nurse("Nurse Organization"),Senatealarm("Senatealarm Organization"),Hospitalalarm("Hospitalalarm Organization");
