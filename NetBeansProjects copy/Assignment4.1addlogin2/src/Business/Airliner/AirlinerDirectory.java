...
public class AirlinerDirectory {
    ...
    public AirlinerDirectory(){
        ...
        Airliner Air1 = new Airliner("airline1",150,"Boeing");
        Airliner Air2 = new Airliner("airline2",150,"Boeing");
        Airliner Air3 = new Airliner("airline3",150,"Airbus");
        Airliner Air4 = new Airliner("airline4",150,"Airbus");
        Airliner Air5 = new Airliner("airline5",150,"OAK");
...
//    }
    ...
    public void getSeatNumber(int i){
        airlinerList.get(i).getSeatNumber();
    }
