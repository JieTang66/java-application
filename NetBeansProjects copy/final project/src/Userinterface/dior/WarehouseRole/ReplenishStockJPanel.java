...
public class ReplenishStockJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        autoSelecteBtn.setBackground(new java.awt.Color(255, 204, 204));
        autoSelecteBtn.setFont(new java.awt.Font("Lucida Grande", 0, 16)); // NOI18N
        autoSelecteBtn.setText("Filte AvailNum： ");
        ...
        requestUpdateBtn.setBackground(new java.awt.Color(255, 204, 204));
        requestUpdateBtn.setFont(new java.awt.Font("Lucida Grande", 0, 16)); // NOI18N
        ...
        productTable.setFont(new java.awt.Font("Lucida Grande", 0, 16)); // NOI18N
        ...
        messageTxt.setFont(new java.awt.Font("Lucida Grande", 0, 16)); // NOI18N
        ...
        productUpdateTable.setBackground(new java.awt.Color(255, 255, 204));
        productUpdateTable.setFont(new java.awt.Font("Lucida Grande", 0, 16)); // NOI18N
        ...
        viewAllBtn.setBackground(new java.awt.Color(255, 204, 204));
        viewAllBtn.setFont(new java.awt.Font("Lucida Grande", 0, 16)); // NOI18N
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(37, 37, 37)
                                        .addComponent(autoSelecteBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(numTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 78, javax.swing.GroupLayout.PREFERRED_SIZE))))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(41, 41, 41)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
    ...
    public void populateNeedReplenishProductTable(){
        DefaultTableModel model = (DefaultTableModel) productTable.getModel();
        model.setRowCount(0);
        int num = Integer.valueOf(numTxt.getText());
        for(Product product : beauty.getProductDir().getProductList()){
            if(product.getAvailNum()<num){
            Object[] row = new Object[6];
            row[0] = product;
            row[1] = product.getProductId();
            row[2] = product.getAvailNum();
